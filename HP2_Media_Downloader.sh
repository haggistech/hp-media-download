...
25) # Nintendo Game Boy Advance
        ...
        check_download "$FILE" "$DIR" "$ROMMD5"
        ;;
26) # Nintendo Game Boy Advance Hacks
        clear
        FILE=gbah.7z
        DIR=gbah
